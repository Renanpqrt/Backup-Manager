...
def abrir_relatorios(janela, area_principal):
    ...
    text_color='#EAEAEA', corner_radius=10)
    rel_contas.place(relx=0.015, rely=0.08)

    rel_contas_dados = ctk.CTkButton(area_principal, text='Contas de Dados', fg_color="#00B4D8", hover_color='#0096C7', width=80, command=relat_contas_dados, 
    text_color='#EAEAEA', corner_radius=10)

...
def abrir_relatorios(janela, area_principal):
    ...
    def relat_contas_data():
        ...
        # Criação da tabela
        tabela = Table(dados_tabela, colWidths=[230, 300, 156, 156])
        tabela.setStyle(TableStyle([("ALIGIN", (0, 0), (-1, -1), "LEFT"),
                                    ('FONTNAME', (0, 0), (-1, 0), 'Helvetica-Bold'),
                                    ('FONTSIZE', (0, 0), (-1, -1), 10),
                                    ('GRID', (0, 0), (-1, -1), 0.5, colors.black),
    ...
    def abrir_menu(tipo, menu):
        ...
        if tipo == 1: # Se for do tipo 1, abrir os relatórios das contas de BKPs
            ...
            rel_contas1 = ctk.CTkButton(menu_lateral_bkp, text='Contas BKPs GERAL', fg_color="#00B4D8", hover_color='#0096C7', width=120, command=relat_contas, text_color='#EAEAEA', corner_radius=10)
            rel_contas1.place(relx=0.01, rely=0.2)

            rel_contas_data1 = ctk.CTkButton(menu_lateral_bkp, text='Contas BKPs DATA', fg_color="#00B4D8", hover_color='#0096C7', width=120, command=relat_contas_data, text_color='#EAEAEA', corner_radius=10)
            rel_contas_data1.place(relx=0.01, rely=0.28)
            ...
            rel_contas2 = ctk.CTkButton(menu_lateral_bkp, text='Contas Dados GERAL', fg_color="#00B4D8", hover_color='#0096C7', width=120, command=relat_contas_dados, text_color='#EAEAEA', corner_radius=10)
            rel_contas2.place(relx=0.01, rely=0.2)

            rel_contas_data2 = ctk.CTkButton(menu_lateral_bkp, text='Contas Dados DATA', fg_color="#00B4D8", hover_color='#0096C7', width=120, command=relat_contas_dados_data, text_color='#EAEAEA', corner_radius=10)
            rel_contas_data2.place(relx=0.01, rely=0.28)

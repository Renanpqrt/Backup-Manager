...
def abrir_cadastros(area_principal):
    ...
    users_b = ctk.CTkButton(area_principal, image=users_imag, text='', width=60, fg_color='#1E1E1E', hover_color="#A9A9A9", command=lambda: abrir_user(area_principal), bg_color='#1E1E1E')
    ...
    contas_b = ctk.CTkButton(area_principal, image=conta_imag, text='', width=60, fg_color='#1E1E1E', hover_color="#A9A9A9", command=lambda: abrir_cadastro_contas(area_principal), bg_color='#1E1E1E')

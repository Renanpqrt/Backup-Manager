...
def abrir_cadastro_contas(janela, frame_atual):
    ...
    deletar_u = ctk.CTkButton(frame_atual, image=excl_img, text='', fg_color='#08254b', hover_color='#A9A9A9', command=lambda: (frame_atual), width=60)
    ...
    segmented_button_selected_color="#011125", segmented_button_selected_hover_color="#011125", segmented_button_unselected_color="gray20", segmented_button_unselected_hover_color="gray20")
        ...
        b_salvar = ctk.CTkButton(tabela.tab('Contas'), text='Cadastrar', fg_color='Green', hover='Green', width=80, command=lambda: salvar(frame_atual))
        b_salvar.place(relx=0.5, rely=0.67, anchor='center')

        # Cadastro de contas de dados
        entry_nome = ctk.CTkEntry(tabela.tab('Contas de dados'), placeholder_text='Digite o nome')
        entry_nome.place(relx=0.5, rely=0.1, anchor='center')

        entry_email = ctk.CTkEntry(tabela.tab('Contas de dados'), placeholder_text='Digite o email')
        entry_email.place(relx=0.5, rely=0.23, anchor='center')

        entry_ultimobkp = ctk.CTkEntry(tabela.tab('Contas de dados'), placeholder_text='Data do ultimo BKP')
        entry_ultimobkp.place(relx=0.5, rely=0.37, anchor='center')

...
def abrir_cadastro_contas(area_principal):
    ...
    segmented_button_selected_color="#011125", segmented_button_selected_hover_color="#011125", segmented_button_unselected_color="gray20", segmented_button_unselected_hover_color="gray20")
        ...
        b_salvar = ctk.CTkButton(tabela.tab('Contas'), text='Cadastrar', fg_color='Green', hover_color='Green', width=80, command=lambda: salvar(area_principal))
        ...
        def salvar_dados(area_principal):
        ...
        b_salvar = ctk.CTkButton(tabela.tab('Contas de dados'), text='Cadastrar', fg_color='Green', hover_color='Green', width=80, command=lambda: salvar_dados(area_principal))
        b_salvar.place(relx=0.5, rely=0.67, anchor='center')
    
    # Exclusão
    def deletar_contas(area_principal):
        limpar_area_principal(area_principal)
